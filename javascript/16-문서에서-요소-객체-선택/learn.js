...
/* const exorcistChracters = document.getElementById('exorcist-characters')
console.log(exorcistChracters)
// 2. id 속성으로 선택한 DOM 요소에서 다음을 수행하세요.
//     1. 태그 또는 클래스 이름, 속성 이름/값 등을 사용해 "박요한"을 선택해보세요.
const backYoHan = document.querySelector('.yo-han')
const backYoHanTag = exorcistChracters.getElementsByTagName('li').item(0)
console.log(backYoHan)
console.log(backYoHanTag)
//     2. 태그 또는 클래스 이름, 속성 이름/값 등을 사용해 "최강림"을 선택해보세요.
const choiKangRim = document.querySelector('.master-choi')
console.log(choiKangRim)
//     3. 태그 또는 클래스 이름, 속성 이름/값 등을 사용해 "악령"을 선택해보세요.
const villanin = document.querySelector('[data-type *="villain"]')
console.log(villanin)
 */
